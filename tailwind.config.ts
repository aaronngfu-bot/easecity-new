...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'display-hero': ['clamp(4.5rem, 13vw, 11rem)', { lineHeight: '0.88', letterSpacing: '-0.055em' }],
        'display-xl': ['clamp(3.2rem, 8vw, 6.5rem)', { lineHeight: '0.95', letterSpacing: '-0.045em' }],
        'display-lg': ['clamp(2.4rem, 5vw, 4.5rem)', { lineHeight: '1', letterSpacing: '-0.035em' }],
