...
function ProductLogo({ product }: { product: Product }) {
  ...
  return (
    <span
      className="grid h-7 w-7 place-items-center rounded-full bg-bg-elevated/60  text-sm"
      aria-hidden="true"
    >
      {product.logo}
    </span>
  ...
  return (
    <section className={`bg-[#050505] px-4 py-20 ${className}`}>
      <div className="mx-auto max-w-6xl">
        ...
        <div className="hidden overflow-hidden rounded-2xl border border-border  bg-bg-elevated/40 [0.03] shadow-[0_30px_90px_rgba(0,0,0,0.35)] md:block">
            ...
            <tbody>
              {rows.map((row, index) => (
                <motion.tr
                  ...
                  className="border-b border-border  transition-colors duration-200 last:border-b-0 hover:bg-bg-elevated/50 "
                >
                  <th
                    scope="row"
            ...
            <div
              ...
              className={`rounded-2xl border p-5 ${
                product.isPrimary
                  ...
                  : "border-border  bg-bg-elevated/40 [0.03]"
              }`}
            >
