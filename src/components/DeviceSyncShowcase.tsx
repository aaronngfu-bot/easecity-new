...
function DesktopConsole({
  ...
  return (
    <div className="relative origin-center transition-all duration-300 lg:[transform:rotateX(3deg)]">
      ...
      <div className="relative rounded-[2rem] border border-border bg-gradient-to-br from-bg-elevated via-bg-base to-bg-void    p-3 shadow-[0_38px_100px_rgba(0,0,0,0.75),inset_0_1px_0_rgba(255,255,255,0.18)]">
        ...
        <div className="relative overflow-hidden rounded-[1.45rem] border border-border bg-bg-void  p-4 shadow-[inset_0_0_70px_rgba(0,229,204,0.07)] md:p-5">
        ...
        <div className="mx-auto mt-3 h-3 w-36 rounded-b-2xl bg-gradient-to-b from-bg-elevated to-bg-base   shadow-[0_12px_28px_rgba(0,0,0,0.55)]" />
      </div>
      <div className="mx-auto h-10 w-32 bg-gradient-to-b from-bg-elevated to-bg-base   shadow-[0_20px_45px_rgba(0,0,0,0.48)]" />
      <div className="mx-auto h-3 w-72 rounded-full bg-gradient-to-r from-transparent via-bg-elevated to-transparent  shadow-[0_18px_38px_rgba(0,0,0,0.48)]" />
    </div>
  )
}
