    ...
    >
      <defs>
        ...
        <filter id="skylineGlow" x="-10%" y="-10%" width="120%" height="130%">
          ...
          <feFlood floodColor="var(--signal)" floodOpacity="0.4" result="color" />
      ...
      <line x1="370" y1="165" x2="530" y2="165" stroke="var(--signal)" strokeWidth="0.4" strokeOpacity="0.15" strokeDasharray="6 6" />
      <line x1="380" y1="170" x2="520" y2="170" stroke="var(--signal)" strokeWidth="0.3" strokeOpacity="0.10" strokeDasharray="4 8" />
      <line x1="390" y1="175" x2="510" y2="175" stroke="var(--signal)" strokeWidth="0.3" strokeOpacity="0.07" strokeDasharray="3 10" />
      ...
      <line x1="104" y1="0" x2="104" y2="-8" stroke="var(--signal)" strokeWidth="0.8" strokeOpacity="0.8" />
      <line x1="680" y1="10" x2="680" y2="2" stroke="var(--signal)" strokeWidth="0.8" strokeOpacity="0.8" />
      <line x1="636" y1="4" x2="636" y2="-4" stroke="var(--signal)" strokeWidth="0.8" strokeOpacity="0.7" />
      ...
      <line x1="104" y1="180" x2="104" y2="165" stroke="var(--signal)" strokeWidth="0.4" strokeOpacity="0.15" />
      <line x1="636" y1="180" x2="636" y2="168" stroke="var(--signal)" strokeWidth="0.4" strokeOpacity="0.12" />
      <line x1="680" y1="180" x2="680" y2="168" stroke="var(--signal)" strokeWidth="0.4" strokeOpacity="0.12" />
    </svg>
  )
}
