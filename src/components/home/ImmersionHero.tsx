...
export function ImmersionHero({ onStartProject }: { onStartProject?: () => void }) {
  ...
  return (
    <section className="relative flex min-h-[100svh] flex-col overflow-hidden bg-[var(--bg-base)]">
        ...
        {/* Small title-local scrim (~5% area) for headline legibility */}
        <div
          aria-hidden
          className="absolute inset-0 bg-[radial-gradient(ellipse_32%_22%_at_15%_26%,var(--bg-base)_55%,transparent_78%)]"
        />
