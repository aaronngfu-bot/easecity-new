      ...
      <nav className={`pill-nav ${className}`} aria-label="Primary">
        ...
        >
          <span className="absolute inset-0 overflow-hidden rounded-full">
            <span className="absolute inset-0 rounded-full bg-[image:radial-gradient(75%_100%_at_50%_0%,rgba(0,143,130,0.4)_0%,rgba(0,143,130,0)_75%)] opacity-0 transition-opacity duration-500 group-hover:opacity-100 " />
          </span>
          <div className="relative z-10 flex items-center space-x-2 rounded-full bg-bg-void px-4 py-0.5 ring-1 ring-border  ring-white/10">
            <span>Sign in</span>
            <svg
              fill="none"
              height="16"
